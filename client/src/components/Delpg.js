...
function Delpg() {
    ...
    const fetchDeliveredProducts = async () => {
        try {
            ...
            const products = response.data.filter(product => product.delivery_status === 'delivered');
    ...
    return (
        <div className='flex'>
            <nav className="bg-zinc-300 w-1/4 min-h-screen p-4">
                <h1 className='text-3xl font-semibold mb-4'>Delivery Panel</h1>
                <ul className="space-y-2">
                    <li>
                        <Link to="/Delpg" className="block py-2 px-4 bg-fuchsia-50 rounded">Past deliveries</Link>
                    </li>
                    <li>
                        <Link to="/Pending" className="block py-2 px-4 hover:bg-fuchsia-50 rounded">Pending deliveries</Link>
                    </li>
            ...
            <div className='bg-blue-200 w-3/4 min-h-screen p-8 relative'>
                ...
                <h1 className="text-3xl font-semibold mb-4">Delivered Products</h1>
